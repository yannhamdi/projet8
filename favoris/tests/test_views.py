...
class FavoriteView(TestCase):
    ...
    def test_display_account(self):
        ...
        fav_4, created = Favorite.objects.get_or_create(user_link=response.context.get('user'),product_searched=Products.objects.get(id_code=20930395), product_substitute=Products.objects.get(id_code=20930393))
        ...
        self.assertTrue(len(self.favoris_list) == 4)
